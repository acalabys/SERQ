...
class Phi3MLP(nn.Module):
    def __init__(self, config):
        ...
        self.config = config
        self.gate_up_proj = SVDLinear(config.hidden_size, 2 * config.intermediate_size, bias=False)
        self.down_proj = SVDLinear(config.intermediate_size, config.hidden_size, bias=False)
...
class Phi3Attention(nn.Module):
    ...
    def __init__(self, config: Phi3Config, layer_idx: Optional[int] = None):
        ...
        self.qkv_proj = SVDLinear(config.hidden_size, op_size, bias=False)
