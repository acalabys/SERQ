...
class PhiAttention(nn.Module):
    ...
    def __init__(self, config: PhiConfig, layer_idx: int):
        ...
        self.dense = SVDLinear(config.num_attention_heads * self.head_dim, config.hidden_size, bias=True)
...
class PhiForCausalLM(PhiPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        self.vocab_size = config.vocab_size
        self.lm_head = SVDLinear(config.hidden_size, config.vocab_size, bias=True)
